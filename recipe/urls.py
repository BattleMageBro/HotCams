...
from .views import index, categories, category, start_stream, stop_stream, single_stream, stream_settings, stream_change_key, streams, private_stream
...
urlpatterns = [
    ...
    path("<str:username>.m3u8/", fake_view, name="hls-url"),
    ...
    path("stream/private/<str:username>/", private_stream, name='private')
]
